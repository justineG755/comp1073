		...
		Use a-z, 0-9, A-Z and underscores, avoiding reserved names (ex. switch)
        ...
        console.log("The results of the comparison (5>2) is: " + compare);
		...
		// Objects
        let myDog = {fName: "Simba", breed: "Staffy", colour: "brown"};
