        ...
        let octalNum = 0o12; //prefix = 0o
        console.log("Octal Number: " + octalNum);
        let hexaNum = 0xF; //prefix = 0x
        ...
        //pre-increment: INCREASE FIRST AND THEN USE
        let a = 4;
        let b = ++a;
        console.log()
        ...
        let c = 2;
        let d = "2";
        console.log(c == d );//checks if the values are the same.
        console.log(c === d );//checks if both the values and the data types are the same
